...
namespace ma_tween {
namespace {
class Driver : public Tween<int, base_engine::ImageComponent> {
 public:
  explicit Driver(base_engine::Actor* owner)
      : Tween<int, base_engine::ImageComponent>(owner) {}

  base_engine::COLOR color;
  bool OnInitialize() override {
    component_weak_ = owner_->GetComponent<base_engine::ImageComponent>();
...
ma_tween::TweenDriver<int>& ma_tween::ImageAlphaTween::TweenImageAlpha(
