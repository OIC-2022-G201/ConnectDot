...
//ONCE
#ifndef		__SLSOUNDBUFFER__H__

#define		__SLSOUNDBUFFER__H__
...
namespace Mof {
	...
	/*******************************//*!
	@brief	SL2でのサウンドバッファクラス

			SL2でのサウンドバッファクラス。

	@author	濱田　享
	*//********************************/
	class MOFLIBRARY_API CSLSoundBuffer : public CSoundBufferBase {
	protected:
		/*******************//*!
		SLOutputMix
		*//********************/
	...
	public:
		...
		*//**************************************************************************/
		...
		/*************************************************************************//*!
				...
				@return			None
		*//**************************************************************************/
		CSLSoundBuffer(const CSLSoundBuffer& pObj);
		/*************************************************************************//*!
				@brief			デストラクタ
				@param			None
		...
		*//**************************************************************************/
		...
		//クラス基本定義
		MOF_LIBRARYCLASS(CSLSoundBuffer,MOF_SLSOUNDBUFFERCLASS_ID);
	};

	#include	"SLSoundBuffer.inl"
	
	//置き換え
	typedef CSLSoundBuffer		CSoundBuffer;
}
