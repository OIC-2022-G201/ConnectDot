/*************************************************************************//*!
					...
					@file	DX11ShaderBind_SpriteBase.h
...
//ONCE
#ifndef		__DX11SHADERBIND_SPRITEBASE__H__

#define		__DX11SHADERBIND_SPRITEBASE__H__
...
namespace Mof {
	...
	@author	CDW
	*//********************************/
	class MOFLIBRARY_API CDX11ShaderBind_SpriteBase : public CShaderBindBase {
	public:
		/*******************************//*!
	...
	public:
		...
		*//**************************************************************************/
		...
		/*************************************************************************//*!
				...
				@return			None
		*//**************************************************************************/
		CDX11ShaderBind_SpriteBase(const CDX11ShaderBind_SpriteBase& pObj);
		/*************************************************************************//*!
				@brief			デストラクタ
				@param			None
				...
				@return			None
		*//**************************************************************************/
		virtual ~CDX11ShaderBind_SpriteBase();
		...
		*//**************************************************************************/
		...
		//クラス基本定義
		MOF_LIBRARYCLASS(CDX11ShaderBind_SpriteBase,MOF_DX11SHADERBINDSPRITEBASECLASS_ID);
	};

	#include	"DX11ShaderBind_SpriteBase.inl"
	
	//置き換え
	typedef CDX11ShaderBind_SpriteBase		CShaderBind_SpriteBase;
