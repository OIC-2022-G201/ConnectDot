/*************************************************************************//*!
					...
					@file	DX11ShaderBind_CascadeVarianceRendererSkinned.h
...
//ONCE
#ifndef		__DX11SHADERBIND_CASCADEVARIANCERENDERERSKINNED__H__

#define		__DX11SHADERBIND_CASCADEVARIANCERENDERERSKINNED__H__
...
namespace Mof {
	...
	@author	CDW
	*//********************************/
	class MOFLIBRARY_API CDX11ShaderBind_CascadeVarianceRendererSkinned : public CShaderBind_SkinGeometryBase {
	public:
		/*******************************//*!
	...
	public:
		/*************************************************************************//*!
				...
				@return			None
		*//**************************************************************************/
		CDX11ShaderBind_CascadeVarianceRendererSkinned();
		/*************************************************************************//*!
				@brief			コピーコンストラクタ
				...
				@return			None
		*//**************************************************************************/
		CDX11ShaderBind_CascadeVarianceRendererSkinned(const CDX11ShaderBind_CascadeVarianceRendererSkinned& pObj);
		/*************************************************************************//*!
				@brief			デストラクタ
				@param			None
				...
				@return			None
		*//**************************************************************************/
		virtual ~CDX11ShaderBind_CascadeVarianceRendererSkinned();
		...
		*//**************************************************************************/
		...
		//クラス基本定義
		MOF_LIBRARYCLASS(CDX11ShaderBind_CascadeVarianceRendererSkinned,MOF_DX11SHADERBINDCASCADEVARIANCERENDERERSKINNEDCLASS_ID);
	};
	
	#include	"DX11ShaderBind_CascadeVarianceRendererSkinned.inl"

	//置き換え
	typedef CDX11ShaderBind_CascadeVarianceRendererSkinned		CShaderBind_CascadeVarianceRendererSkinned;
