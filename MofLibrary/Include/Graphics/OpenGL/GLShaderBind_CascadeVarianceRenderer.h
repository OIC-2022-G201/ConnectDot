/*************************************************************************//*!
					...
					@file	GLShaderBind_CascadeVarianceRenderer.h
...
//ONCE
#ifndef		__GLSHADERBIND_CASCADEVARIANCERENDERER__H__

#define		__GLSHADERBIND_CASCADEVARIANCERENDERER__H__
...
namespace Mof {
	...
	@author	CDW
	*//********************************/
	class MOFLIBRARY_API CGLShaderBind_CascadeVarianceRenderer : public CShaderBind_3DPrimitiveBase {
	public:
		/*******************************//*!
	...
	public:
		/*************************************************************************//*!
				...
				@return			None
		*//**************************************************************************/
		CGLShaderBind_CascadeVarianceRenderer();
		/*************************************************************************//*!
				@brief			コピーコンストラクタ
				...
				@return			None
		*//**************************************************************************/
		CGLShaderBind_CascadeVarianceRenderer(const CGLShaderBind_CascadeVarianceRenderer& pObj);
		...
		*//**************************************************************************/
		...
		//クラス基本定義
		MOF_LIBRARYCLASS(CGLShaderBind_CascadeVarianceRenderer,MOF_GLSHADERBINDCASCADEVARIANCERENDERERCLASS_ID);
	};
	
	#include	"GLShaderBind_CascadeVarianceRenderer.inl"

	//置き換え
	typedef CGLShaderBind_CascadeVarianceRenderer		CShaderBind_CascadeVarianceRenderer;
