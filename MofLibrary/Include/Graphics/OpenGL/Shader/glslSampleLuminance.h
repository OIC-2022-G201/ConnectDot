...
const char* g_SampleLuminance_VS =
"attribute vec4 pos;\n"
"attribute vec2 Tex;\n"
"varying vec2 OUV;\n"
"varying vec4 OVCOL;\n"
...
const char* g_SampleLuminance_PS =
...
"void main(){\n"
	...
	"gl_FragColor = vec4(0.298912f * color.r + 0.586611f * color.g + 0.114478f * color.b);\n"
"}\n";


#else
extern const char* g_SampleLuminance_VS;
extern const char* g_SampleLuminance_PS;
#endif
