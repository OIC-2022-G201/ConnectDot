...
const char* g_SpriteBase_PS =
"precision mediump float;\n"
"varying vec2 OUV;\n"
"varying vec4 OVCOL;\n"
"uniform sampler2D txDiffuse;\n"
"void main(){\n"
	"gl_FragColor = texture2D(txDiffuse, OUV) * OVCOL;\n"
"}\n";


#else
extern const char* g_SpriteBase_VS;
extern const char* g_SpriteBase_PS;
#endif
