...
const char* g_3DPrimitiveBase_VS =
"attribute vec4 pos;\n"
...
const char* g_3DPrimitiveBase_PS =
...
"void main(){\n"
	...
	"float l = max( 0.0, dot( ONORMAL, -litDirection ) );\n"
	...
	"ocol.xyz += litSpeculer.xyz * matSpeculer.xyz * pow( abs( max( 0.0 , dot( R, -litDirection ) ) ) , matPower );\n"
	"gl_FragColor = ocol;\n"
"}\n";

#else
extern const char* g_3DPrimitiveBase_VS;
extern const char* g_3DPrimitiveBase_PS;
#endif
