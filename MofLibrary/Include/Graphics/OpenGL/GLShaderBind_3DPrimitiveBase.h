/*************************************************************************//*!
					...
					@file	GLShaderBind_3DPrimitiveBase.h
...
//ONCE
#ifndef		__GLSHADERBIND_3DPRIMITIVEBASE__H__

#define		__GLSHADERBIND_3DPRIMITIVEBASE__H__
...
namespace Mof {
	...
	@author	CDW
	*//********************************/
	class MOFLIBRARY_API CGLShaderBind_3DPrimitiveBase : public CShaderBindBase {
	public:
		/*******************************//*!
	...
	public:
		...
		*//**************************************************************************/
		...
		/*************************************************************************//*!
				...
				@return			None
		*//**************************************************************************/
		CGLShaderBind_3DPrimitiveBase(const CGLShaderBind_3DPrimitiveBase& pObj);
		/*************************************************************************//*!
				@brief			デストラクタ
				@param			None
				...
				@return			None
		*//**************************************************************************/
		virtual ~CGLShaderBind_3DPrimitiveBase();
		...
		*//**************************************************************************/
		...
		//クラス基本定義
		MOF_LIBRARYCLASS(CGLShaderBind_3DPrimitiveBase,MOF_GLSHADERBIND3DPRIMITIVEBASECLASS_ID);
	};

	#include	"GLShaderBind_3DPrimitiveBase.inl"

	//置き換え
	typedef CGLShaderBind_3DPrimitiveBase		CShaderBind_3DPrimitiveBase;
